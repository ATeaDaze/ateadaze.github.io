...
const defaultGreeting = "🃏 BLACKJACK PAYS 3:2";
...
function updateBet() {
  if(nPlayerCards < 3) {
    btnBet50.src = "../images/50active.png";
    btnBet100.src = "../images/100active.png";
    btnBet200.src = "../images/200active.png";
    switch(betAmount) {
    case 50:
...
function disableBets() {
  ...
  btnBet50.disabled = true;
  btnBet100.disabled = true;
  btnBet200.disabled = true;
}

function enableBets() {
  btnBet50.disabled = false;
  btnBet100.disabled = false;
  btnBet200.disabled = false;
}